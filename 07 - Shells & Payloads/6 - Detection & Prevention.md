...
MITRE ATT&CK Enterprise Framework matrix showing tactics like Initial Access, Execution, Persistence, and techniques under each category.
...
Wireshark displaying TCP packet capture with source and destination IPs, protocol details, and hex data view.
...
Wireshark TCP stream showing commands for directory listing and user creation with net user and net localgroup commands.
